...
const MediaSorts = {
  ...
  [MediaSort.Popularity]: (media: Media, media2: Media) => numberSort(media.popularity, media2.popularity),
  [MediaSort.PopularityDesc]: (media: Media, media2: Media) => reverseNumberSort(media.popularity, media2.popularity),
